...
public class JasperXLSExporter {
	...
	public static void exportToXLS(InputStream inStream,
		...
		/*
		 * Note that only HTML, PDF and XML can be exported directly to ServletOutputStream, for
		 * all other formats we need to create the file on server, push it to output and then delete
		 * the temporarily created file.
		 */
